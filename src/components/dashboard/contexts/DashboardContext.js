...
const menuItems = [
  {id: 1,title: 'Home',icon: 'bx bx-home',link: '/dashboard',active: false},
  {id:2, title: 'Consumer',icon: 'bx bx-user',link: '',active: false,items:[
    {subId: 1,title: 'All',icon: 'bx bx-list-ul',link: '/dashboard/consumers',active: false}
  ]},
  {id: 3,title: 'Admins',icon: 'bx bx-group',link: '',active: false,items:[
    {isubIdd: 1,title: 'All',icon: 'bx bx-list-ul',link: '/dashboard/admins',active: false},
